...
$consulta_destacadas = "SELECT * FROM noticias";
...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('static/diario_app/svg/logo.svg') }}" />
    <title>El Trebol</title>
...
<body>
    <header class="d-flex flex-wrap align-items-center justify-content-between py-3 mb-4 border-bottom">
        ...
        <div id="botones" class="text-end">
            <ul id="sueltos" class="nav nav-pills">
                <li class="nav-item"><a href="{{ route('home') }}" class="nav-link activo" aria-current="page">Inicio</a>
                </li>
                <!--<li class="nav-item">-->
                <!--    <div class="dropdown">-->
                ...
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('news_in_segment', ['segment' => 'politica']) }}">Política</a>
                            </li>
                            <li>
                                <a class="dropdown-item disabled"
                                    href="{{ route('news_in_segment', ['segment' => 'sociedad']) }}">Sociedad</a>
                            </li>
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('news_in_segment', ['segment' => 'cultura']) }}">Cultura</a>
                            </li>
                            <li>
                                <a class="dropdown-item disabled"
                                    href="{{ route('news_in_segment', ['segment' => 'deportes']) }}">Deportes</a>
                            </li>
                            <li>
                                <a class="dropdown-item disabled"
                                    href="{{ route('news_in_segment', ['segment' => 'unsam']) }}">UNSAM</a>
                            </li>
                        </ul>
                    </div>
                </li>
    ...
    <main>
        <div class="in_container">
                        ...
                        <div class="nota_principal">
                            <a href="#">
                                <div class="card text-bg-dark">
                                    <img src="img/Imagen de WhatsApp 2024-01-11 a las 16.53.20_11531dca.jpg" class="card-img" alt="nose">
                    ...
                    <?php if($noticias['is_field'] == 2): ?>
                        <a href="#">
                            <div class="card border-1 border-top-0 border-end-0 border-start-0">
                                <img src="img/Imagen de WhatsApp 2024-01-11 a las 16.53.20_11531dca.jpg" class="card-img-top" alt="nose">
                                <div class="card-body">
            ...
            <div id="tres_notas_y_publi" class="hero">
                ...
                <!-- <div class="publi">
                    @foreach ($publis as $publi)
                        @if ($publi->is_field == 1)
                            <a href="{{ $publi->link }}">
                                <img src="{{ asset('storage/' . $publi['image']) }}" alt="{{ $publi->title }}">
                            </a>
                        @endif
                    @endforeach
                    @foreach ($publis as $publi)
            ...
            <!-- #region nota 7, 8 y 9 -->
            <div id="tres_notas" class="hero">
                <?php foreach ($resultado_destacadas as $noticias ): ?>
                    <?php if($noticias['is_field'] == 7): ?>
                        <a href="#">
                            <div class="card border-1 border-black border-top-0 border-end-0 border-start-0 ">
                                <img src="img/Imagen de WhatsApp 2024-01-11 a las 16.53.20_11531dca.jpg" class="card-img-top" alt="<?php echo $noticias['titulo']; ?>">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo $noticias['titulo']; ?></h5>
                                    <p class="card-text"><?php echo $noticias['contenido']; ?></p>
                                </div>
            ...
            <div id="cuatro_notas" class="hero">
                <!-- 12 -->
                <?php foreach ($resultado_destacadas as $noticias ): ?>
            ...
            <div id="segmento" class="hero">
                ...
                <div class="principal">
                    <div class="nota_fuerte">
                        ...
                        <a href="#">
                            <div class="card border-0">
                                <img src="img/Imagen de WhatsApp 2024-01-11 a las 16.53.20_11531dca.jpg" class="card-img-top" alt="<?php echo $poliMain['titulo']; ?>">
                                <div class="card-body">
                                    <h3 class="card-title">
                                        <span><?php echo $poliMain['titulo']; ?></span>
                                        <?php echo $poliMain['contenido']; ?>
                                    </h3>
                                </div>
                            </div>
                        </a>
                ...
                <div id="cuatro_notas">
                    <?php foreach ($poliSec as $noticias ): ?>
                        ...
                        <a href="#">
                            <div class="card border-0">
                                <img src="{{ asset('storage/' . $note['image']) }}" class="card-img-top" alt="<?php echo $noticias['titulo']; ?>">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo $noticias['titulo']; ?></h5>
                                    <p class="card-text"><?php echo $noticias['contenido']; ?></p>
                                </div>
