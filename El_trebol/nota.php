        ...
        <div class="nt_container">
            <div class="nota_fuerte">
                <div class="card border-0">
                    ...
                    <h1><?php echo $noticia['titulo']; ?> <?php echo $noticia['contenido']; ?></h1>
                    ...
                    <?php if ($noticia['contenido_2']): ?>
                        <p><?php echo $noticia['contenido_2']; ?></p>
                    <?php endif; ?>

                    <?php if ($noticia['imagen_2']): ?>
                        <img src="img/<?php echo $noticia['imagen_2']; ?>" class="card-img-top img-principal" alt="<?php echo $noticia['titulo']; ?>">
                    <?php endif; ?>
                    ...
                    <?php if ($noticia['contenido_3']): ?>
                        <p><?php echo $noticia['contenido_3']; ?></p>
                    <?php endif; ?>

                    <?php if ($noticia['imagen_3']): ?>
                        <img src="img/<?php echo $noticia['imagen_3']; ?>" class="card-img-top img-principal" alt="<?php echo $noticia['titulo']; ?>">
                    <?php endif; ?>

                    <?php if ($noticia['video_2']): ?>
                        <div class="yt">
                    ...
                    <?php if ($noticia['contenido_4']): ?>
                        <p><?php echo $noticia['contenido_4']; ?></p>
                    <?php endif; ?>

                    <!-- Repite lo mismo para content_3, image_3, video_3, y así sucesivamente... -->
