            ...
            <ul id="sueltos" class="nav nav-pills">
                ...
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="seccion.php?politica">Política</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="seccion.php?sociedad">Sociedad</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="seccion.php?cultura">Cultura</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="seccion.php?deportes">Deportes</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="seccion.php?unsam">UNSAM</a>
                            </li>
                        </ul>
                    </div>
                </li>
        ...
        <div class="in_container">
                        ...
                        <div class="nota_principal">
                            <a href=" nota.php?id_noticia=<?php echo $noticias['id']; ?> ">
                                <div class="card text-bg-dark">
                                    <img src="img/<?php echo $noticias['imagen']; ?>" class="card-img" alt="nose">
                    ...
                    <?php if($noticias['is_field'] == 2): ?>
                        <a href=" nota.php?id_noticia=<?php echo $noticias['id']; ?> ">
                            <div class="card border-1 border-top-0 border-end-0 border-start-0">
                                <img src="img/<?php echo $noticias['imagen']; ?>" class="card-img-top" alt="nose">
                                <div class="card-body">
                ...
                <div class="publi">
                    <?php foreach ($publis as $publi ): ?>
                        <?php if($publi['is_field'] == 1): ?>
                            <a href="#">
                                <img src="img/<?php echo $publi['imagen']; ?>" alt="<?php echo $noticias['titulo']; ?>">
                            </a>
                        <?php endif; ?>
                    <?php endforeach; ?>
                    <?php foreach ($publis as $publi ): ?>
            ...
            <div id="segmento" class="hero">
                ...
                <div class="principal">
                    <div class="nota_fuerte">
                        <?php if($poliMain): ?>
                        <a href=" nota.php?id_noticia=<?php echo $poliMain['id']; ?> ">
                            <div class="card border-0">
                ...
                <div id="cuatro_notas">
                    <?php foreach ($poliSec as $noticias ): ?>
                        <?php if($poliSec): ?>
                            <a href=" nota.php?id_noticia=<?php echo $poliSec['id']; ?> ">
                            <div class="card border-0">
                                <img src="img/<?php echo $poliSec['imagen']; ?>" class="card-img-top" alt="<?php echo $noticias['titulo']; ?>">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo $noticias['titulo']; ?></h5>
                                    <p class="card-text"><?php echo $noticias['contenido']; ?></p>
                                </div>
