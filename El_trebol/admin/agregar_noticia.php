...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES['imagen'])) {
    ...
    $consulta = "INSERT INTO noticias (titulo, contenido, contenido_2, contenido_3, contenido_4, is_field, imagen, imagen_2, imagen_3, video, video_2, video_3, segment, region, priority_segment, priority_region, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())";

    // Preparar la declaración
    $stmt = $conexion->prepare($consulta);

    // Enlazar parámetros
    $stmt->bind_param("ssssssssssssssss", $titulo, $contenido, $contenido_2, $contenido_3, $contenido_4, $is_field, $imagen, $imagen_2, $imagen_3, $video, $video_2, $video_3, $segment, $region, $priority_segment, $priority_region);
